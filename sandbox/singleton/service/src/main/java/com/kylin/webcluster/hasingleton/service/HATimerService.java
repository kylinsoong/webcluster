...
public class HATimerService implements Service<String> {
    ...
    public static final ServiceName SINGLETON_SERVICE_NAME = ServiceName.JBOSS.append("webcluster", "ha", "singleton", "timer");
    ...
    public void start(StartContext arg0) throws StartException {
        ...
        try {
            ...
            ((Scheduler) ic.lookup(PropsLoader.schedulerJNDI())).initialize("HASingleton timer @" + this.nodeName + " " + new Date());
    ...
    public void stop(StopContext context) {
        ...
        if (!started.compareAndSet(true, false)) {
            ...
            try {
                InitialContext ic = new InitialContext();
                ((Scheduler) ic.lookup(PropsLoader.schedulerJNDI())).stop();
            } catch (NamingException e) {
